...
public class Library {
	...
	ArrayList bookList = new ArrayList();	//인스턴스를 생성하여 도서 목록을 저장
	...
	ArrayList rentableList() {
		...
		//대출 가능한 책을 찾고, 이를 result 리스트에 추가
...
//		System.out.println("]");
	...
	void printBookList(ArrayList list) {		System.out.println("도서 목록");
		System.out.print("[");
		for(int i=0; i<list.size(); i++) {
			
			Book book = (Book)list.get(i);
			String title = book.title;
			if(i != list.size() - 1) {	// 맨뒤에 콤마 없애는법
				title += ", ";
			}
